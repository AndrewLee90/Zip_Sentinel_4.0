...
test_cases = [
    {"file_path": "lama_test_samples/test_1.zip", "password": "infected"},
    {"file_path": "lama_test_samples/test_2.rar", "password": "Yahoo123"},
    {"file_path": "lama_test_samples/test_3.7z", "password": "Yahoo123!"},
    {"file_path": "lama_test_samples/test_4.tar.gz", "password": "infected"},
]
